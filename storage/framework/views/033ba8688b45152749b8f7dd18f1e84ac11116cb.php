...
<div class="container-fluid">
    <div class="card shadow mb-4">
          <div class="card-body">
            ...
            <form action="<?php echo e(route('travel.update',$travel->id)); ?>" method="post" enctype="multipart/form-data">
                <?php echo method_field('PUT'); ?>
                <?php echo csrf_field(); ?>
                <div class="form-group">
                    <label>Name </label>
                    <input type="text" name="name" value="<?php echo e($travel->name); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>Variant </label>
                    <input type="text" name="variant" value="<?php echo e($travel->variant); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>Price </label>
                    <input type="number" name="price" value="<?php echo e($travel->price); ?>" class="form-control">
                    <?php $__errorArgs = ['variant'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="/images/travels/<?php echo e($travel->thumbnail); ?>"  class="img-fluid" width="500px" >
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>Content</label>
                    <textarea class="form-control" id="content" name="content" rows="3"><?php echo e($travel->content); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard-admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Monza\Developer\Project\KMJ-trans\logistic-app\resources\views/dashboard-admin/travel/edit.blade.php ENDPATH**/ ?>