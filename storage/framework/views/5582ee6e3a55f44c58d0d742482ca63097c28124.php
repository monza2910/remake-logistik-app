...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <img src="<?php echo e($partner->image); ?>" class="img-fluid" width="200px" alt="Preview image">
                </div>
                <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    <label>Website</label>
                    <input type="url" placeholder="https://example.com" name="website" value="<?php echo e($partner->website); ?>" class="form-control">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard-admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Envoin\Product\Website\Project\remake-logistik-app\resources\views/dashboard-admin/partner/edit.blade.php ENDPATH**/ ?>