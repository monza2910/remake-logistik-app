          ...
          <div class="card-body">
            ...
            <form action="<?php echo e(route('slider.store')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title_one" value="<?php echo e(old('title_one')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title_two" value="<?php echo e(old('title_two')); ?>" class="form-control">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard-admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Kerjaan\BOIS\Project\KMJTRANS\example-appcompany-profile\resources\views/dashboard-admin/slider/create.blade.php ENDPATH**/ ?>